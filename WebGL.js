...
var FSHADER_SOURCE = `
    ...
    void main(){
        ...
        vec3 lightDirection = normalize((u_LightPosition * u_LightMatrix).xyz - v_PositionInWorld);
...
async function main(){
    ...
    sizeSlider.oninput = function() {
        size = this.value / 100.0; //convert sliders value to -1 to +1
        draw(gl);
    }
    ...
    var slider4 = document.getElementById("move2");
    slider4.oninput = function() {
        moveDistance2 = this.value/60.0
        draw();
    }
    ...
    var slider3 = document.getElementById("rotate2");
...
function draw(){
    ...
    drawOneObject(cube, mdlMatrix, 0.8, 0.9, 0.9);
 
    //fox
    //TODO-2: set mdlMatrix for fox
    mdlMatrix.setIdentity();
    mdlMatrix.translate(0.0, 0.2, 0.0);
    mdlMatrix.scale(0.005, 0.005, 0.005);
    drawOneObject(fox, mdlMatrix, 1.0, 0.6, 0.2);

    //tree
    //TODO-3: set mdlMatrix for tree (include rotation and movement)
    mdlMatrix.setIdentity();
    mdlMatrix.translate(0.5, 0.3, 0.0);
    mdlMatrix.scale(0.8, 0.8, 0.8);
    mdlMatrix.rotate(rotateAngle, 0.0, 1.0, 0.0);
    drawOneObject(tree, mdlMatrix, 0.4, 1.0, 0.7);

    //cube
    mdlMatrix.setIdentity();
    mdlMatrix.translate(-1.0+moveDistance/5, 0.3, 0.0);
    mdlMatrix.translate(0.0, 0.0, moveDistance2/5);
    mdlMatrix.scale(0.2, 0.2, 0.4);
    drawOneObject(cube, mdlMatrix, 1.0, 0.8, 0.9);
    mdlMatrix.scale(5, 5, 2.5);
    ...
    //arm1
    mdlMatrix.rotate(20-moveDistance*10, 0.0, 0.0, 1.0);
    mdlMatrix.rotate(-moveDistance2*20, 0.0, 1.0, 0.0);
    mdlMatrix.rotate(rotateAngle, 0.0, 0.0, 1.0);
    mdlMatrix.translate(0.4, 0.15, 0.0);
    mdlMatrix.scale(0.4, 0.1, 0.1);
    drawOneObject(cube, mdlMatrix, 1.0, 0.8, 0.9);
    mdlMatrix.scale(2.5, 10, 10);

    //ball
    mdlMatrix.translate(0.5, 0.0, 0.0);
    mdlMatrix.scale(0.1, 0.1, 0.1);
    drawOneObject(ball, mdlMatrix, 1.0, 1.0, 1.0);
    mdlMatrix.scale(10, 10, 10);

    //arm2
    mdlMatrix.rotate(40+moveDistance*25, 0.0, 0.0, 1.0);
    mdlMatrix.rotate(-moveDistance2*25, 0.0, 1.0, 0.0);
    mdlMatrix.rotate(rotateAngle2, 0.0, 0.0, 1.0);
    mdlMatrix.translate(0.3, 0.0, 0.0);
    mdlMatrix.scale(0.2, 0.05, 0.05);
    drawOneObject(cube, mdlMatrix, 1.0, 0.8, 0.9);
    mdlMatrix.scale(5, 20, 20);

    //pyramid
    mdlMatrix.translate(0.4, -0.2, 0.0);
    mdlMatrix.scale(0.02, 0.02, 0.02);
    mdlMatrix.rotate(0.0, 1.0, 0.0, 0.0);
    drawOneObject(pyramid, mdlMatrix, 1.0, 0.7, 0.7);
}
...
function drawOneObject(obj, mdlMatrix, colorR, colorG, colorB){
    ...
    mvpMatrix.lookAt(cameraX-size, cameraY, cameraZ-size, 0, 0, 0, 0, 1, 0);
